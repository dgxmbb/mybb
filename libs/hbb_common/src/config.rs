...
lazy_static::lazy_static! {
    ...
    pub static ref NEW_STORED_PEER_CONFIG: Mutex<HashSet<String>> = Default::default();
        ...
        map.insert("relay-server".to_string(), "nas.ym5368.top".to_string());
        RwLock::new(map)
    };
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        let mut map = HashMap::new();
        map.insert("password".to_string(), "Gezi2025.".to_string());
        RwLock::new(map)
    };
...
pub const RS_PUB_KEY: &str = "onPxOmJmAr5mnBHrqo3A2wzY58NMUqSZTCEN70t+prk=";
